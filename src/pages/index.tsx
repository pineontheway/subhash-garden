        ...
        <div className="max-w-md mx-auto min-h-screen flex flex-col items-center justify-center p-6 relative z-10">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 w-full max-w-sm">
            ...
            <button
              ...
              className="w-full py-4 bg-blue-600 text-white text-lg font-semibold rounded-xl hover:bg-blue-700 active:bg-blue-800 transition-colors cursor-pointer flex items-center justify-center gap-3 shadow-lg"
            >
